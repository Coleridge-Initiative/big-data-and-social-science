...
```
```{r fig8-7b, out.width = '70%', fig.align = 'center', echo = FALSE, fig.cap = 'DUMMY TEXT'}
knitr::include_graphics("ChapterNetworks/figures/fig8-7b.png")
```


```{r fig8-8, out.width = '70%', fig.align = 'center', echo = FALSE, fig.cap = 'The main component of two university networks'}
