...
includes workbooks that can be run online, which allows to quickly interact 
with the code examples. *Workbook Set 2* provides workbooks that can be 
...
corresponding Binder link (*interact*). The full set of workbooks is
...
short summary of the content that each covers.
