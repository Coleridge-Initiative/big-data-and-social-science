...
```{r fig1, out.width = '70%', fig.align = 'center', echo = FALSE, fig.cap = 'Use of pre-existing survey data in publications in leading journals, 1980--2010 [@Chetty2012]'}
...
\textbf{JL: FIGURE 2 should be included around here.}
...
```{r fig2, out.width = '70%', fig.align = 'center', echo = FALSE, fig.cap = 'A visualization of the complex links between what and who is funded, and the results; tracing the direct link between funding and results is misleading and wrong'}
...
**BOX**
** The Institute for Research on Innovation and Science (IRIS iris.isr.umich.edu) at the University of Michigan has extended the data infrastructure even more.   By working with universities interested in documenting the results of their grant funding, they are able to trace the spending of almost 400,000 grants to over 600,000 individuals and 820,000 vendors - and show the direct effects on that funding on their subsequent scientific and economic activity \cite{InstituteForResearchOnInnovationAndScienceIRISResearch2019}
** Additional Examples**
...
```{r projectfig, out.width = '100%', fig.align = 'center', echo = FALSE, fig.cap = 'The data science project workflow. Blue represents each step in the project, orange represents the tools used in that step, and green represents the methods for analysis.'}
...
```{r fig3, out.width = '70%', fig.align = 'center', echo = FALSE, fig.cap = 'The four chapters of Part I focus on *data capture* and *curation*'}
knitr::include_graphics("ChapterIntro/figures/Figure2.png")
```
...
```{r fig4, out.width = '70%', fig.align = 'center', echo = FALSE, fig.cap = 'The four chapters in Part II focus on data *modeling* and *analysis*'}
knitr::include_graphics("ChapterIntro/figures/Figure3.png")
```
...
```{r fig5, out.width = '70%', fig.align = 'center', echo = FALSE, fig.cap = 'The four chapters in Part III focus on *inference* and *ethics*'}
knitr::include_graphics("ChapterIntro/figures/Figure4.png")
```
