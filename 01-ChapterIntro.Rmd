...
Finally, the disparate complex data sets need to be stored in databases ([Databases]), integrated ([Record Linkage]), analyzed [Machine Learning](#chap:ml), and used to make inferences ([Errors and Inference]).
