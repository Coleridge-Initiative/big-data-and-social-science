...
While this chapter focuses on social networks, the techniques described here have beemn used to examine the structure of networks such as the World Wide Web, the national
...
```{r fig8-1, out.width = '70%', fig.align = 'center', echo = FALSE, fig.cap = 'Undirected, binary, one-mode network data'}
knitr::include_graphics("ChapterNetworks/figures/fig8-1.png")
```
...
```{r fig8-2, out.width = '70%', fig.align = 'center', echo = FALSE, fig.cap = 'Directed, valued, one-mode network data'}
knitr::include_graphics("ChapterNetworks/figures/fig8-2.png")
```
...
```{r fig8-3, out.width = '70%', fig.align = 'center', echo = FALSE, fig.cap = 'Two-mode affiliation data'}
knitr::include_graphics("ChapterNetworks/figures/fig8-3.png")
```
...
```{r fig8-4, out.width = '70%', fig.align = 'center', echo = FALSE, fig.cap = 'Reachability and indirect ties'}
knitr::include_graphics("ChapterNetworks/figures/fig8-4.png")
```
...
```{r fig8-5, out.width = '70%', fig.align = 'center', echo = FALSE, fig.cap = 'Histogram of path lengths for university A employee network'}
knitr::include_graphics("ChapterNetworks/figures/fig8-5.png")
```
...
```{r fig8-6, out.width = '70%', fig.align = 'center', echo = FALSE, fig.cap = 'The main component of two university networks'}
knitr::include_graphics("ChapterNetworks/figures/fig8-6.png")
```
...
```{r fig8_7b, out.width = '70%', fig.align = 'center', echo = FALSE}
knitr::include_graphics("ChapterNetworks/figures/fig8-7a.png")
```
```{r fig8-7a, out.width = '70%', fig.align = 'center', echo = FALSE, fig.cap = 'Degree distribution for two universities'}
knitr::include_graphics("ChapterNetworks/figures/fig8-7b.png")
```
...
```{r fig8-8, out.width = '70%', fig.align = 'center', echo = FALSE, fig.cap = 'Distribution of path lengths for universities A and B'}
knitr::include_graphics("ChapterNetworks/figures/fig8-8.png")
```
