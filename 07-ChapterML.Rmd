...
```{block, type='F00'}
**Box 6.2: Social Science machine learning examples**
...
Box 6.2 describes a few social science and policy problems that are being tackled using machine learning today.
...
The Machine Learning process [todo:image]
----------------------------
