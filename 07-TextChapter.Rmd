...
```{r nyt_topics-1, out.width = '70%', fig.align = 'center', echo = FALSE, fig.cap = 'Topics are distributions over words. Here are three example topics learned by latent Dirichlet allocation from a model with 50 topics discovered from the *New York Times* [@sandhaus-08]. Topic 1 seems to be about technology, Topic 2 about business, and Topic 3 about the arts'}
knitr::include_graphics("ChapterText/figures/nyt_topics-1.png")
```
```{r nyt_topics-2, out.width = '70%', fig.align = 'center', echo = FALSE, fig.cap = 'DUMMY TEXT'}
knitr::include_graphics("ChapterText/figures/nyt_topics-2.png")
```
```{r nyt_topics-3, out.width = '70%', fig.align = 'center', echo = FALSE, fig.cap = 'DUMMY TEXT'}
...
```{r nyt_documents, out.width = '70%', fig.align = 'center', echo = FALSE, fig.cap = 'Allocations of documents to topics'}
...
```{r inference_1, out.width = '70%', fig.align = 'center', echo = FALSE, fig.cap = 'Each word is associated with a topic. Gibbs sampling inference iteratively resamples the topic assignments for each word to discover the most likely topic assignments that explain the document collection'}
