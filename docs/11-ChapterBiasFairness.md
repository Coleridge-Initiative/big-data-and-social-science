...
<div class="figure" style="text-align: center">
<img src="ChapterBias/figures/tutorial_plot_crosstabs.png" alt="Visualizing metrics at the same time using small multiples can help identify differences between groups." width="100%" />
<p class="caption">(\#fig:tutorial-plot-crosstabs)Visualizing metrics at the same time using small multiples can help identify differences between groups.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="ChapterBias/figures/tutorial_plot_disparity.png" alt="Plotting disparity can show any significant difference, with two asterisks denoting statistical significance." width="100%" />
<p class="caption">(\#fig:tutorial-plot-disparity)Plotting disparity can show any significant difference, with two asterisks denoting statistical significance.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="ChapterBias/figures/tutorial_plot_fairness1.png" alt="You can plot a single fairness metric across different groups, such as age category, sex, and race." width="100%" />
<p class="caption">(\#fig:tutorial-plot-fairness1)You can plot a single fairness metric across different groups, such as age category, sex, and race.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="ChapterBias/figures/tutorial_plot_fairness2.png" alt="You can plot a treemap of fairness results. Here, the disparity by race is shown." width="100%" />
<p class="caption">(\#fig:tutorial-plot-fairness2)You can plot a treemap of fairness results. Here, the disparity by race is shown.</p>
</div>
