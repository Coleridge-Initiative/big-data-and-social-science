...
<img src="ChapterParallel/figures/data2compute.png" alt="(a) The traditional parallel computing model where data are brought to the computing nodes. (b) Hadoop’s parallel computing model: bringing compute to the data [242]" width="70%" />
<p class="caption">(\#fig:fig5-1a)(a) The traditional parallel computing model where data are brought to the computing nodes. (b) Hadoop’s parallel computing model: bringing compute to the data [242]</p>
</div>
<div class="figure" style="text-align: center">
<img src="ChapterParallel/figures/compute2data.png" alt="(a) The traditional parallel computing model where data are brought to the computing nodes. (b) Hadoop’s parallel computing model: bringing compute to the data [242]" width="70%" />
<p class="caption">(\#fig:fig5-1b)(a) The traditional parallel computing model where data are brought to the computing nodes. (b) Hadoop’s parallel computing model: bringing compute to the data [242]</p>
</div>
...
Figure \@ref(fig:fig5-1a)(a). This computing model will be referred
...
Figure \@ref(fig:fig5-1b)(b), when users submit a task to be run on
