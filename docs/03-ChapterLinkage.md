...
strategies for data preprocessing. In this section, we focus
...
then there is again the possibility of bias in the linked data set. One
...
on identifying potential links using approaches that are fast and
...
In recent years machine learning approaches have been applied to record
...
linkage is the random forest model [@Breiman01]. This is a
...
be left out intentionally out of concern for privacy, or they may simply
...
of big data this is more challenging..
