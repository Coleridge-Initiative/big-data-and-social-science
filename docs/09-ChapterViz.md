...
Figure [\[fig:viz-1\]](#fig:viz-1){reference-type="ref"
reference="fig:viz-1"}, "Anscombe's quartet" [@anscombe1973graphs],
...
\centering
![image](ChapterViz/figures/fig2)

\vspace*{-12pt}
Data analysis tools can enable analysis of structured and generic data
sets. Figure [\[fig:viz-2\]](#fig:viz-2){reference-type="ref"
reference="fig:viz-2"} shows an exploratory browser of a selection of
...
\afterpage{\clearpage}
\centering
![image](ChapterViz/figures/fig3-a)

\centering
![image](ChapterViz/figures/fig3-b)

Commercial tools such as Spotfire and Tableau, among many other tools
(see Section [1.6](#sec:mylabel4){reference-type="ref"
reference="sec:mylabel4"}), allow users to create visualizations by
...
[\[fig:viz-3a\]](#fig:viz-3a){reference-type="ref"
reference="fig:viz-3a"} shows the charting interface of Tableau on a
...
Figure [\[fig:viz-3b\]](#fig:viz-3b){reference-type="ref"
reference="fig:viz-3b"} shows a treemap [@johnson1991tree] for agency
...
(Figure [\[fig:viz-4\]](#fig:viz-4){reference-type="ref"
reference="fig:viz-4"}; see also
...
\centering
![Visual elements described by MacKinlay
[@mackinlay1986automating][\[fig:viz-4\]]{#fig:viz-4
label="fig:viz-4"}](ChapterViz/figures/fig4)
...
Section [1.3.4](#sec:viz-2.5){reference-type="ref"
reference="sec:viz-2.5"}). For example, $k$-means clustering starts by
...
\afterpage{\clearpage}
\centering
![image](ChapterViz/figures/fig5)

Maps are commonly combined with other visualizations. For example, in
Figure [\[fig:viz-5\]](#fig:viz-5){reference-type="ref"
reference="fig:viz-5"}, the US Cancer Atlas combines a map showing
...
Time series data
(Figures [\[fig:viz-6\]](#fig:viz-6){reference-type="ref"
reference="fig:viz-6"} and
[\[fig:viz-7\]](#fig:viz-7){reference-type="ref" reference="fig:viz-7"})
...
Figure [\[fig:viz-7\]](#fig:viz-7){reference-type="ref"
reference="fig:viz-7"} shows EventFlow used to visualize sequences of
...
Figure [\[fig:viz-8\]](#fig:viz-8){reference-type="ref"
reference="fig:viz-8"}, is used to browse a company organizational
...
Figure [\[fig:viz-9\]](#fig:viz-9){reference-type="ref"
reference="fig:viz-9"} shows the Finviz treemap that helps users monitor
...
\centering
![image](ChapterViz/figures/fig9)

### Network data {#sec:viz-2.6}

\centering
![image](ChapterViz/figures/fig10)
...
\centering
![image](ChapterViz/figures/fig10-b)

\vspace*{12pt}
[Node-link diagrams]{.roman} are the most common representation of
network structures and overviews (Figures
[\[fig:viz-10\]](#fig:viz-10){reference-type="ref"
reference="fig:viz-10"} and
[\[fig:viz-10b\]](#fig:viz-10b){reference-type="ref"
reference="fig:viz-10b"}), and may use linear (arc), circular, or force-
...
Figure [\[fig:viz-10\]](#fig:viz-10){reference-type="ref"
reference="fig:viz-10"} shows the networks of inventors (white) and
...
Figure [\[fig:viz-10b\]](#fig:viz-10b){reference-type="ref"
reference="fig:viz-10b"} shows an example of network visualization on
...
Figure [\[fig:viz-11\]](#fig:viz-11){reference-type="ref"
reference="fig:viz-11"} shows an example using Jigsaw
...
\centering
![image](ChapterViz/figures/fig11)
