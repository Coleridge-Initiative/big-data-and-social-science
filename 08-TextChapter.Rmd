...
There are a lot of tyypes iof analysis that we can do with text data. Table X gives a summary of these types of analysis. For this chapter, we will focus on two types of needs that social scientists have when encountering text data: 
...
2. The second use case is less focused on "discovery" and understanding new content and instead focuses on classifying content into a pre-defined set of categories. 
