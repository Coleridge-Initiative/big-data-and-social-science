...
```{r pipeline, out.width = '70%', fig.align = 'center', echo = FALSE}
...
Precision computes the type I errors---*false
positives*---and is formally
defined as
...
```{r nyt_topics-1, out.width = '70%', fig.align = 'center', echo = FALSE}
knitr::include_graphics("ChapterText/figures/nyt_topics-1.png")
```

```{r nyt_topics-2, out.width = '70%', fig.align = 'center', echo = FALSE}
knitr::include_graphics("ChapterText/figures/nyt_topics-2.png")
```

```{r nyt-topics-3, out.width = '70%', fig.align = 'center', echo = FALSE, fig.cap = 'Topics are distributions over words. Here are three example topics learned by latent Dirichlet allocation from a model with 50 topics discovered from the *New York Times* [@sandhaus-08]. Topic 1 appears to be about technology, Topic 2 about business, and Topic 3 about the arts'}
