...
% TODO(jbg): Add reference to book
...
%TODO(jbg): Finish this subsection

In discussing topic models, we learned a vector that summarized the
content of each document.  However, modern research doesn't stop
there, it learns vector representations of everything from documents
down to sentences and words.

% These techniques aren't always the best tools for social scientists: they're not interpretable

% You can't always trust them

% Given our goal is understanding, it is probably better to start first with the simpler (and faster methods) mentioned here to understand your data first.
...
% TODO(jbg): Add in Spacy.io

% TODO(jbg): Add in pytorch
